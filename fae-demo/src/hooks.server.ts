import { PRIVATE_FIREBASE_ADMIN_CONFIG, PRIVATE_GITHUB_CLIENT_SECRET, PRIVATE_GOOGLE_CLIENT_SECRET } from "$env/static/private";
import { PUBLIC_FIREBASE_CONFIG, PUBLIC_GITHUB_CLIENT_ID, PUBLIC_GOOGLE_CLIENT_ID } from "$env/static/public";
